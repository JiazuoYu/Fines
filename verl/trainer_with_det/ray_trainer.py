...
class RayPPOTrainer:
    ...
    def _load_checkpoint(self):
        ...
        ckpt_path = global_step_folder if self.config.trainer.resume_mode == "resume_path" and global_step_folder is not None else self.config.trainer.load_checkpoint_path
