...
def main():
    ...
    # checkpoint = "//13390024681/All_Model_Zoo/sam2-hiera-large/sam2_hiera_large.pt"
    # model_cfg = "//13390024681/All_Model_Zoo/sam2-hiera-large/sam2_hiera_l.yaml"
    ...
    logger.info("User question:{}".format(args.text))
    ...
    logger.info("Masks:{}".format(masks.dtype))    
    logger.info("Masks:{}".format(masks.shape))
