...
def json2parquet(json_path, save_path, split, num_limit, all_image_path, new_size, chunk_size, resize_box=False):
    ...
    for ann in tqdm(anno):
        ...
        assert res, "res should not be empty!"
            # print(res)
        solution = get_solution_from_box_ref_seg(bbox, res)
        if type == "option":
...
if __name__ == "__main__":
    ...
    save_path = "/15324359926/seg/HD_Reasoning-main-yjz/All_final_data/all_parquet/converted_data_1920gt_resize_box_qa_v1_before_revised_mask_final_version"
